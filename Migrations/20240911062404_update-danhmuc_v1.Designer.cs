...
namespace ERP.Migrations
{
    ...
    [Migration("20240911062404_update-danhmuc_v1")]
    partial class updatedanhmuc_v1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Models.ChucDanh_NhomChucDanh", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("NhomChucDanhId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("NhomChucDanhId");

                    b.ToTable("ChucDanh_NhomChucDanh");
                });
            ...
            modelBuilder.Entity("ERP.Models.DM_NSKhongDanhGia", b =>
                {
                    ...
                    b.Property<int>("ThoiDiemDanhGia")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.Models.DanhMucTyTrong", b =>
                {
                    ...
                    b.Property<double>("NhomChiTieuCTQT")
                        .HasColumnType("float");

                    b.Property<double>("NhomChiTieuSXKD")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("ERP.Models.NhomChucDanh", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("TenNhomChucDanh")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
            ...
            modelBuilder.Entity("ERP.Models.ChucDanh_NhomChucDanh", b =>
                {
                    ...
                    b.HasOne("ERP.Models.DanhMucTyTrong", "DanhMucTyTrong")
                        .WithMany("ChucDanh_NhomChucDanhs")
                        .HasForeignKey("DanhMucTyTrongId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ERP.Models.NhomChucDanh", "NhomChucDanh")
                        .WithMany("ChucDanh_NhomChucDanhs")
                        .HasForeignKey("NhomChucDanhId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ERP.Models.DanhMucTyTrong", b =>
                {
                    b.Navigation("ChucDanh_NhomChucDanhs");
                });
