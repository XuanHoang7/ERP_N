            ...
            modelBuilder.Entity("ERP.Models.ChiTieuKPI.CapDuyet", b =>
                {
                    ...
                    b.Property<Guid>("LanhDaoDanhGiaId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("LanhDaoPhongKPIId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("NhanVienId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("PheDuyetId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("LanhDaoDanhGiaId");

                    b.HasIndex("LanhDaoPhongKPIId");

                    b.HasIndex("NhanVienId");

                    b.HasIndex("PheDuyetId");
            ...
            modelBuilder.Entity("ERP.Models.ChiTieuKPI.CapDuyet", b =>
                {
                    ...
                    b.HasOne("ERP.Data.MyDbContext+ApplicationUser", "LanhDaoDanhGia")
                        .WithMany()
                        .HasForeignKey("LanhDaoDanhGiaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ERP.Data.MyDbContext+ApplicationUser", "LanhDaoPhongKPI")
                        .WithMany()
                        .HasForeignKey("LanhDaoPhongKPIId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("ERP.Data.MyDbContext+ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("PheDuyetId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("LanhDaoDanhGia");

                    b.Navigation("LanhDaoPhongKPI");
